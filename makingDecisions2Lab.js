...
//'There are not enough elements in this array' to the console. If the length is more than 7, reassign the 
//value of 'someNum' to the value of the 7th element in the array. (Hint: how can you make sure that 
...
/* The famous FizzBuzz, Devmountain style!
  Create a for loop that iterates from 1 to 100. In this for loop, using some conditional logic, if the number 
  your for loop is currently on is divisible by 3, console.log 'Dev'. If the number is divisible by 5, 
  console.log 'mountain'. If the number is divisible by 5 & 3, console.log 'Devmountain'. If the number is 
  not divisible by 5 or 3, console.log the number itself. Hint: Look up the modulo operator.
